...
**Files:**
- Create: `libs/onewili/` from the generated OneWili C API release (`CMakeLists.txt`, `README.md`, `src/` 5 files, `include/` 6 headers, `examples/blink.c`)
...
mkdir -p libs
# Copy the generated OneWili C API release into libs/onewili.
...
```cmake
# OneWili C API for WiliBSP (FreeWili 2 display CPU, RP2350B).
# Generated by the OneWili API generator; replace from a generated release rather than editing here.
# Drop this directory into your wilibsp tree and add_subdirectory() it, or
```
